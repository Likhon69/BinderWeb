...
var loginRuleHelper = {
    ...
    clearLoginRulePolicy: function () {
        ...
        $("#txtAttendanceRegulariseDays").val('');
    ...
    validateLoginRuleForm: function () {
        ...
        if (validator.validate()) {
            ...
            var companyId = $("#cmb_CompanyName").data("kendoComboBox").value();
    ...
    CreateLoginRuleObjectForSave: function (objSystemSettings) {
        ...
        objSystemSettings.IsPasswordChange = $("#chkIsPasswordChange").is(":checked") == true ? 1 : 0;
        objSystemSettings.IsPasswordExpire = $("#chkIsPasswordExpire").is(":checked") == true ? 1 : 0;
        return objSystemSettings;
    },
    ...
    GenerateLoginRuleData: function (objSystemSettings) {
        ...
        if (objSystemSettings.IsPasswordChange == 1) {
            $("#liChangePassword").show();
            $("#chkIsPasswordChange").prop('checked', 'checked');
        } else {
            $("#liChangePassword").hide();
            $("#chkIsPasswordChange").removeProp('checked', 'checked');
        }
        ...
        if (objSystemSettings.IsPasswordExpire == 1) {
            $("#liPasswordExpire").show();
            $("#chkIsPasswordExpire").prop('checked', 'checked');
        } else {
            $("#liPasswordExpire").hide();
            $("#chkIsPasswordExpire").removeProp('checked', 'checked');
        }
    ...
    changeCompanyName: function () {
        ...
        if(objSystemSettings != null) {
            ...
            hrPolicyHelper.PopulateHrPolicy(objSystemSettings);
        }
        else {
            loginRuleHelper.InitiateloginRuleAndPolicy();
        }
    ...
    IsPasswordChangedOrExpire:function () {
        $('#chkIsPasswordChange').click(function (e) {
            var $cb = $(this);
            if ($cb.is(":checked")) {
        ...
        $('#chkIsPasswordExpire').click(function (e) {
            var $cb = $(this);
            if ($cb.is(":checked")) {
