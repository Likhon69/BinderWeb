...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Branch>(entity =>
            {
                ...
                entity.Property(e => e.BranchDescription).HasMaxLength(2000);
            ...
            modelBuilder.Entity<DealerWithLocationMapping>(entity =>
            {
                entity.HasOne(d => d.Dealer)
                    .WithMany(p => p.DealerWithLocationMapping)
                    .HasForeignKey(d => d.DealerId)
                    .HasConstraintName("FK_DealerWithLocationMapping_DealerInformation");

                entity.HasOne(d => d.Location)
                    .WithMany(p => p.DealerWithLocationMapping)
                    .HasForeignKey(d => d.LocationId)
                    .HasConstraintName("FK_DealerWithLocationMapping_Branch");
            });
            ...
            modelBuilder.Entity<EmailContent>(entity =>
            {
                ...
                entity.Property(e => e.NotifcationBody).HasMaxLength(1000);
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.Property(e => e.NotificationText).HasMaxLength(1000);
            ...
            {
                entity.HasIndex(e => e.MessageDetailsId)
                    .HasName("IX_MessageDetails");
                ...
                entity.HasOne(d => d.Message)
                    .WithMany(p => p.MessageDetailsNavigation)
                    .HasForeignKey(d => d.MessageId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_MessageDetails_Message");
            });
            ...
            modelBuilder.Entity<ProductOrder>(entity =>
            {
                ...
                entity.Property(e => e.SocConfirmationDate).HasColumnType("datetime");
