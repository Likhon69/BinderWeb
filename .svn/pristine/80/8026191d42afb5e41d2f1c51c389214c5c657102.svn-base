...
var toDoHelper = {
    ...
    GeneratedToDoColumns: function () {
        return columns = [
            { field: "MenuName", title: "QUICK LINK", width: 100, sortable: false, template: '#= toDoHelper.ViewDetails(data) #' },
    ...
    ViewDetails: function (data) {
        ...
        if (data.MenuPath != "") {
            var res = '<a style="text-decoration:none;" href="' + data.MenuPath + '" target="_blank" title="Click Here">' + data.MenuName + '</a>';
    ...
    //    $('#todoGrid table tr').click(function () {
